'use strict';
// ══ AUTO CACHE CLEAR + STALE-CODE CRASH SHIELD (v34) — must run first ═══════
require('./lib/precious-cache-clear.cjs').clearAll();
require('./lib/precious-stale-guard.cjs').verify({ name: 'server' });
