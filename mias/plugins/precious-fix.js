...
module.exports = {
  name: "precious-fix",
  description: "Fix NSFW, play, video, getpp, add",
  version: "1.0",
  author: "PRECIOUS",
  enabled: true,
  commands: [
    { name: ["play", "music", "song"], handler: playCmd, desc: "Player card + choices", category: "DOWNLOAD" },
    { name: ["video", "yt", "ytdl", "videodl", "viddl"], handler: videoCmd, desc: "Download video", category: "DOWNLOAD" },
    { name: ["getpp", "getdp", "dp", "pfp2"], handler: getppCmd, desc: "Get profile picture", category: "INFO" },
    { name: "add", handler: addCmd, desc: "Add members (group/VCF/gclink)", category: "GROUP" },
    { name: "nsfw", handler: nsfwImageCmd("waifu"), desc: "NSFW image", category: "HENTAI" },
    { name: "adult", handler: nsfwImageCmd("waifu"), desc: "NSFW image", category: "HENTAI" },
    { name: ["xnxxdl", "xnxx"], handler: nsfwDlCmd("XNXX"), desc: "XNXX downloader", category: "HENTAI" },
    { name: ["xvideosdl", "xvideos", "xvdl", "xvl"], handler: nsfwDlCmd("XVideos"), desc: "XVideos downloader", category: "HENTAI" },
  ],
};
